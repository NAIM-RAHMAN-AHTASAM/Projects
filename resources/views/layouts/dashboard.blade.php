  ...
  <body>
    ...
    <div class="sl-sideleft">
      ...
      <div class="sl-sideleft-menu">
        ...
        <a href="{{url('add/quote')}}" class="sl-menu-link">
          <div class="sl-menu-item">
            <i class="menu-item-icon icon ion-ios-email-outline tx-24"></i>
            <span class="menu-item-label">Quote</span>
          </div><!-- menu-item -->
        </a><!-- sl-menu-link -->


        <a href="{{url('/get/quote/list')}}" class="sl-menu-link">
          <div class="sl-menu-item">
            <i class="menu-item-icon icon ion-ios-photos-outline tx-20"></i>
            <span class="menu-item-label">Quote FrontEnd Part</span>
          </div><!-- menu-item -->
        </a><!-- sl-menu-link -->
        ...
        <a href="#" class="sl-menu-link">
          <div class="sl-menu-item">
            ...
            <span class="menu-item-label">Reserv Dropdown</span>
